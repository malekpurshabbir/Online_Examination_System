      ...
      <ul class="nav navbar-nav">
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">User<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=9">Add User</a></li>
            <li><a href="dash.php?q=1">User List</a></li>
          </ul>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Master<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=6">Subject</a></li>
            <li><a href="dash.php?q=7">Class</a></li>
            <li><a href="dash.php?q=8">Teacher</a></li>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Subject Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addsubject"  method="POST">
<fieldset>
...
<div class="form-group">
              ...
              <option value="M">First Year</option>
              <option value="F">Second Year</option> 
              <option value="F">Third Year</option>
              </select>
              </div>
</div>
...
?>
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Class Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addsubject"  method="POST">
<fieldset>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Class name" class="form-control input-md" type="text">
...
<div class="form-group">
              ...
              <div class="col-md-12">
                <select id="gender" name="gender" placeholder="Enter your gender" class="form-control input-md" >
              <option value="Male">Select Class Teacher</option>
              <option value="M">First Year</option>
              <option value="F">Second Year</option> 
              <option value="F">Third Year</option>
              </select>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Email Id" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Mobile Number" class="form-control input-md" type="text">
...
?>
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter User Detail</b></span><br /><br />
...
<!-- Text input-->
           ...
           <!--  <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for=""></label>
              <div class="col-md-12"> 
                <input  type="submit" class="sub" value="Create User" class="btn btn-primary"/>
              </div>
            </div>
